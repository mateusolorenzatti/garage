...
<div class='container col-md-6'>
    <div class="card text-center">
        <div class="card-header">
            <h2 class='text-danger'> Não foi possível adicionar este veículo. </h2>
        </div>
        <div class="card-block">
            ...
            <div class="row m-2">
                <div class="float-left form-group col-md-2">
                    <?php echo anchor('Main/abrirAdicionarVeiculo', 'Tentar novamente', array('class' => 'btn btn-success'));
                    ?>
                </div>
